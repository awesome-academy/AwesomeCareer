...
public class ExperiencesController {
	...
	private static final Logger logger = LoggerFactory.getLogger(ExperiencesController.class);
	...
	public String addExperience(@ModelAttribute ExperienceModel experienceModel, BindingResult bindingResult,
			Model model) throws ParseException {
		experienceModel.setUserId(1);
		logger.info("ten cua experience : " + experienceModel.getCompanyName());
